<div>
    <div>
                                ...
                                <table class="table table-sm mb-0 fs--1 table-view-tickets">
                                    <thead class="text-800 bg-light">
                                        <tr>
                                            ...
                                            <th class="sort align-middle ps-2" data-sort="link">Link</th>
                                    ...
                                    <tbody class="list" id="table-ticket-body">
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle subject py-1 pe-1"><a href="{{$item->link}}" target="_blank">{{$item->link}}</a></td>
                                            <td class="align-middle subject py-1 pe-1 text-end">
                                                <div class="btn-group g-2">
                                                    <button type="button" data-bs-toggle="modal" data-bs-target="#addSocialModal" wire:click="edit({{$item->id}})" class="btn btn-sm btn-falcon-primary rounded"><i class="fe fe-edit-3"></i></button>
        ...
        <!-- add edit modal -->
        <div class="modal fade" id="addSocialModal" data-bs-keyboard="false" data-bs-backdrop="static" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" wire:ignore.self>
                    ...
                    <div class="modal-body p-0">
                        ...
                        <div class="p-4 pb-0">                            
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control @error('link') is-invalid @enderror" id="link" type="text" wire:model="link" placeholder="link" />
                            </div>
