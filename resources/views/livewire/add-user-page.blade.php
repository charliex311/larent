<div>
            ...
            <form wire:submit.prevent="saveChanges">
                ...
                <div class="card mb-2 shadow-sm">
                    ...
                    <div class="card-body bg-light">
                        <div class="row g-2 mb-2">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6">
                                ...
                                <div class="input-group">
                                    <select wire:model="customer_type" id="customer_type" class="form-select">
                                        <option value="">Select</option>
                                        @foreach($types as $titem)
                                        <option value="{{$titem->name}}">{{$titem->name}}</option>
                                        @endforeach
                                    </select>
                                    <button class="btn btn-falcon-primary btn-sm add-customer-type" type="button"><span class="fe fe-plus"></span></button>
                                </div>
                            </div>
                            @endif
                            <div class="col-sm-12 {{ $role == 'Customer' ? 'col-md-3 col-lg-3' : 'col-md-6 col-lg-6' }}">
                                <div class="form-group">
                                    ...
                                    <input 
                                        ...
                                        @error('first_name') <small class="text-danger"><strong>{{$message}}</strong></small> @enderror
                                </div>
                            </div>
                            <div class="col-sm-12 {{ $role == 'Customer' ? 'col-md-3 col-lg-3' : 'col-md-6 col-lg-6' }}">
                                <div class="form-group">
                                    ...
                                    <input 
                                        ...
                                        @error('last_name') <small class="text-danger"><strong>{{$message}}</strong></small> @enderror
                                </div>
                            </div>
                        </div>
                        <div class="row g-2 mb-2">
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                <div class="form-group">
                                    ...
                                    wire:model="phone" />
                                    @error('phone') <small class="text-danger"><strong>{{$message}}</strong></small> @enderror
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                <div class="form-group">
                        ...
                        <div class="row g-2 mb-2">
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                ...
                                <input type="date" wire:model="date_of_birth" id="date_of_birth" class="form-control" />
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                <label for="street"><b>Street :</b></label>
                                <input type="text" wire:model="street" id="street" class="form-control" placeholder="Street" />
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                <label for="postal_code"><b>Postal Code :</b></label>
                                <input type="text" wire:model="postal_code" id="postal_code" class="form-control" placeholder="Postal Code" />
                            </div>
                        </div>
                        <div class="row g-2 mb-2">
                            <div class="col-sm-12 col-md-4 col-lg-4">
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                ...
                                <input type="text" wire:model="country" id="country" class="form-control" placeholder="Country" />
                            </div>
                            <div class="col-sm-12 col-md-4 col-lg-4">
                                <label for="nationality"><b>Nationality :</b></label>
                                <input type="text" wire:model="nationality" id="nationality" class="form-control" placeholder="Nationality" />
                            </div>
                        </div>
                        @endif
                        ...
                        @if($row)
                            ...
                            <div class="row my-4">
                                ...
                                <div class="col-sm-12 col-md-12 col-lg-12 mb-5">
                                    ...
                                    <div class="avatar avatar-5xl">
                                        <img class="rounded-circle img-thumbnail shadow-sm" src="{{photo($row->id)}}" width="200" alt="">
                                        <a href="{{photo($row->id)}}" target="_blank" class="btn btn-falcon-default btn-sm my-2">View Profile Picture</a>
                                    </div>
                                </div>
                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-sm-12 col-md-2 col-lg-2">
                                    ...
                                    <input type="number" class="form-control" id="hourly_rate" min="0" wire:model="hourly_rate" placeholder="hourly_rate" />
                                </div>
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    <label for="bank"><b>Bank :</b></label>
                                    <input type="text" wire:model="bank" id="bank" class="form-control" placeholder="Bank" />
                                </div>
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    <label class="form-label" for="bic"><b>BIC:</b></label>
                                    <input type="text" wire:model="bic" id="bic" class="form-control @error('bic') is-invalid @enderror" placeholder="Enter BIC">
                                </div>
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    <label for="iban"><b>IBan :</b></label>
                                    <input type="text" wire:model="iban" id="iban" class="form-control" placeholder="Iban" />
                                </div>
                                <div class="col-sm-12 col-md-4 col-lg-4">
                                    <label class="form-label" for="ust_idnr"><b>USt-IdNr:</b></label>
                                    <input type="text" wire:model="ust_idnr" id="ust_idnr" class="form-control @error('ust_idnr') is-invalid @enderror" placeholder="Enter USt-IdNr" >
                                </div>
                            </div>
                        @endif
                    ...
                    <div class="card-footer">
                        <button class="btn btn-primary" type="submit">{{$row ? 'Update ' : 'Add'}} {{$role}}</button>
                    </div>
                </div>
    ...
    <div class="modal" id="add-customer-type-modal" data-bs-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="p-5 pt-2">
                        <form id="typeFormData">
                            <div class="mb-3">
                                ...
                                <input class="form-control" id="type_title" type="text" placeholder="Enter Title..." />
        ...
        $(document).on('click', '.submit-type-button', function(){
            ...
            $.ajax({
                ...
                error: function(xhr) {
                    ...
                    $('.message-here').removeClass('text-success').addClass('text-danger').text(errorMessage);
                    $('.submit-type-button').text('Submit');
                }
            });
        });
