            ...
            <div class="d-lg-flex justify-content-between">
                <div class="row flex-between-center gy-2 px-x1">
                    <div class="col-auto pe-0">
                        <h6 class="mb-0">All Withdraw (<span class="text-success">Paid</span>)</h6>
                    </div>
                ...
                <table class="table table-sm mb-0 fs--1 table-view-tickets">
                    <thead class="text-800 bg-light">
                        <tr>
                            ...
                            <th class="sort align-middle ps-2 text-end" data-sort="status">Status</th>
                        </tr>
                    </thead>
                    <tbody class="list" id="table-ticket-body">
                        @if(count($lists) == 0)
                        <tr>
                            <td colspan="6" class="text-center">Not Found <i class="fe fe-alert-triangle text-warning"></i></td>
                        </tr>
                        @endif
                        ...
                        <tr>
                            ...
                            <td class="align-middle subject py-1 pe-2"><span class="badge rounded-pill bg-success">{{ $item->amount.' '.currencySign() }}</span></td>
